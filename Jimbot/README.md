...
- **Formato de código:** Prettier + ESLint (configuración en root)
...
┃ ┣ clips/              # Módulo Clips
┃ ┣ conversion/         # Módulo Conversion
┃ ┣ edit-type/          # Módulo Edit-Type
┃ ┣ editor/             # Módulo Editor
┃ ┣ processing/         # Módulo Processing
┃ ┣ thumbnails/         # Módulo Thumbnails
┃ ┣ transcriptions/     # Módulo Transcriptions
┃ ┣ upload/             # Módulo Upload
┃ ┣ youtube/            # Módulo YouTube
┃ ┣ globals.css         # fuente única de tokens y resets
┃ ┣ layout.tsx          # layout raíz (Sidebar + Providers)
┃ ┗ page.tsx            # página home / dashboard general
┣ components/           # UI library y layout
┃ ┣ ui/                 # componentes atómicos (Button, Card…)
┃ ┣ app-sidebar.tsx     # Sidebar principal
┃ ┗ theme-provider.tsx  # Proveedor de tema (Tailwind, Sonner…)
┣ hooks/                # hooks compartidos (use-mobile, use-toast)
┣ lib/
┃ ┗ utils.ts            # funciones utilitarias
┣ public/               # assets públicos (imágenes placeholders…)
┣ styles/
┃ ┗ globals.css         # LEGACY (no importar en nuevas vistas)
┣ next.config.mjs
┣ tailwind.config.ts
┣ tsconfig.json
┣ package.json
...
- app/globals.css: fuente canónica de tokens (claro/oscuro) y resets.
- styles/globals.css: LEGACY (no usar en nuevos módulos).
